...
# the Python the shell tree runs, found by node, against what the flat chain finds
cargo run --release -p reader --bin python-embed-report -- <corpus> [--show tree-only|flat-only N]
