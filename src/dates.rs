...
//! began, everything ever lost lived in a temp-directory project, and a restore
//! reads back byte-identical (memview#1247, #1240).
//!
...
//! monthly 6 / yearly 1. Writing the date into each memory's frontmatter is still
